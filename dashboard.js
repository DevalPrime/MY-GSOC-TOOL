...
// Cache-bust JSON fetches so GitHub Pages/browser caches do not show stale data.
...
async function loadGitHubData(config) {
    ...
    try {
        return await fetchJson('data/github-contributions.json');
    } catch (e) {
...
async function loadBlogPosts() {
    try {
        return await fetchJson('data/blog-posts.json');
    } catch (error) {
...
async function loadMentorInteractions() {
    try {
        return await fetchJson('data/mentor-interactions.json');
    } catch (error) {
...
async function loadWeeklyUpdates() {
    try {
        return await fetchJson('data/weekly-updates.json');
    } catch (error) {
...
async function loadMilestones() {
    try {
        return await fetchJson('data/milestones.json');
    } catch (error) {
